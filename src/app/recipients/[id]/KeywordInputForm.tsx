    ...
    <div className="animate-in fade-in duration-500">
      ...
      <form onSubmit={handleGenerate} className="flex flex-col">
        <textarea
          ...
          className="w-full h-48 bg-transparent border-0 border-b-2 border-surface-200 p-0 focus:ring-0 focus:border-black resize-none transition-colors text-black text-2xl font-light placeholder:text-surface-200"
        />
        <div className="flex justify-end mt-12">
          <button
            type="submit"
            disabled={loading || !keywords.trim()}
            className="px-12 py-5 bg-black text-white text-base font-bold tracking-widest hover:bg-surface-800 transition-all disabled:opacity-30"
          >
