      ...
      <form onSubmit={handleGenerate} className="flex flex-col">
        <div className="relative w-full">
          <textarea
            ...
            className="w-full min-h-[300px] bg-white border border-surface-300 hover:border-surface-400 transition-colors rounded-lg p-6 pb-12 focus:ring-2 focus:ring-black focus:outline-none focus:border-transparent resize-none text-black text-2xl font-light placeholder:text-surface-500 leading-[1.8]"
          />
