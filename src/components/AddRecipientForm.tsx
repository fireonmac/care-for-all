          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-8">
            <div>
              <input
                ...
                className="w-full bg-surface-100 border border-surface-200 p-4 rounded-xl focus:ring-1 focus:border-black text-black text-xl font-light placeholder:text-surface-500 shadow-inner"
                required
              />
            </div>
